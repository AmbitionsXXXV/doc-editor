...
import { useShadCNComponentsContext } from '@doc-editor/feature-ui/ShadCNComponentsContext'
...
export function Toolbar(props: ToolbarProps & { ref?: React.Ref<HTMLDivElement> }) {
	const { className, children, onMouseEnter, onMouseLeave, ref, ...rest } = props
...
export function ToolbarButton(
	props: ToolbarButtonProps & { ref?: React.Ref<HTMLButtonElement> },
) {
	const {
		className,
		children,
...
export function ToolbarSelect(
	...
	const { className, items, isDisabled, ref, ...rest } = props
