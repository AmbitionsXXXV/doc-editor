...
export class FormattingToolbarView implements PluginView {
	...
	constructor(
		private readonly editor: EtcDocEditor<
			BlockSchema,
			InlineContentSchema,
			StyleSchema
		>,
	...
	getSelectionBoundingBox() {
		...
		return posToDOMRect(this.pmView as unknown as EditorView as any, from, to)
	}
}
...
export class FormattingToolbarProsemirrorPlugin extends EventEmitter<any> {
	...
	constructor(editor: EtcDocEditor<any, any, any>) {
		super()
