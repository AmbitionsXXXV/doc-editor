...
> {
	...
	constructor(
		private readonly editor: EtcDocEditor<BSchema, I, S>,
	...
	closeMenu = () => {
		this.editor.dispatch(
			this.editor._tiptapEditor.view.state.tr.setMeta(suggestionMenuPluginKey, null),
		)
	}
					...
					if (
						...
						return {
							...
							deleteTriggerCharacter:
								suggestionPluginTransactionMeta.deleteTriggerCharacter !== false,
...
export function createSuggestionMenu<
	...
	I extends InlineContentSchema,
	S extends StyleSchema,
>(editor: EtcDocEditor<BSchema, I, S>, triggerCharacter: string) {
