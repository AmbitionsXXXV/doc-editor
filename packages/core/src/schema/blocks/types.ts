...
export type EtcDocDOMAttributes = Partial<{
	[DOMElement in EtcDocDOMElement]: Record<string, string>
}>
...
export type PartialBlockNoDefaults<
	...
	I extends InlineContentSchema,
	S extends StyleSchema,
> = PartialBlocksWithoutChildren<BSchema, I, S>[keyof PartialBlocksWithoutChildren<
	BSchema,
	I,
	S
>] &
