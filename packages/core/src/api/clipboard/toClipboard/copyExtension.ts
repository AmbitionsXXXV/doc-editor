...
} from '../../nodeConversions/nodeToBlock'
...
>(
	...
	if (isWithinTable) {
		...
		// first convert selection to etcdoc-style table content, and then
		...
		// first convert selection to etcdoc-style inline content, and then
		// pass this to the exporter
...
>(
	...
	//  some reason.
	event.clipboardData!.setData('etcdoc/html', clipboardHTML)
					...
					props: {
						handleDOMEvents: {
							...
							dragstart(view, event) {
								...
								// TODO: Writing to other MIME types not working in Safari for
								//  some reason.
								event.dataTransfer!.setData('etcdoc/html', clipboardHTML)
