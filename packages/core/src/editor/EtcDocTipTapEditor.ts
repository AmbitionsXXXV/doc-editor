import { EditorOptions, Editor as TiptapEditor, createDocument } from '@tiptap/core'
 ...
 */
export class EtcDocTipTapEditor extends TiptapEditor {
	private _state: EditorState

	public static create = (
		options: EtcDocTipTapEditorOptions,
		...
		try {
			return new EtcDocTipTapEditor(options, styleSchema)
		} finally {
			if (oldSetTimeout) {
...
;(EtcDocTipTapEditor.prototype as any).createView = function () {
	// no-op
