...
> {
	...
	// Helper so that you can use typeof schema.EtcDocEditor
	public readonly EtcDocEditor: EtcDocEditor<BSchema, ISchema, SSchema> =
		'only for types' as any

	public readonly Block: BlockNoDefaults<BSchema, ISchema, SSchema> =
		'only for types' as any

	public readonly PartialBlock: PartialBlockNoDefaults<BSchema, ISchema, SSchema> =
		'only for types' as any
